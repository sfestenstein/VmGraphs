...
public class XAxisRenderer
{
    ...
    public void drawXAxis(Graphics2D acGraphics, int anXOffset, int anYOffset, JPanel acPanel)
    {
        ...
        for (int lnI = 0; lnI < mnNumberXTicks; lnI++)
        {
            int lnTickPixel = lnI * (acPanel.getWidth()-anXOffset)/mnNumberXTicks;
    ...
    private void drawTick(Graphics2D acGraphics, int anMarkerValue, int anXOffset, int anYOffset, JPanel acPanel)
    {
        ...
        acGraphics.drawLine(anXOffset, acPanel.getHeight()-anYOffset, anXOffset, acPanel.getHeight()-(anYOffset-mnTickLengthInPixels));
